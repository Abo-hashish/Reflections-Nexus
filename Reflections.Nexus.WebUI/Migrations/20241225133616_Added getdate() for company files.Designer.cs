...
namespace Reflections.Nexus.WebUI.Migrations
{
    ...
    [Migration("20241225133616_Added getdate() for company files")]
    partial class Addedgetdateforcompanyfiles
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Reflections.Nexus.WebUI.Models.HeadCountItem", b =>
                {
                    ...
                    b.HasIndex(new[] { "DepartmentId" }, "IX_HeadCountItem_DepartmentId");
                    ...
                    b.HasIndex(new[] { "JobTitleId" }, "IX_HeadCountItem_JobTitleId");
                    ...
                    b.HasIndex(new[] { "WorkingModelId" }, "IX_HeadCountItem_WorkingModelId");
            ...
            modelBuilder.Entity("Reflections.Nexus.WebUI.Models.HeadCountItem", b =>
                {
                    b.HasOne("Reflections.Nexus.WebUI.Models.Department", "Department")
                        ...
                        .IsRequired()
                        .HasConstraintName("FK_HeadCountItem_FromDepartment");
                    ...
                    b.HasOne("Reflections.Nexus.WebUI.Models.IdentificationType", "IdentificationType")
                        ...
                        .HasForeignKey("IdentificationTypeId")
                        .IsRequired()
                        .HasConstraintName("FK_HeadCountItem_HeadCountItem");

                    b.HasOne("Reflections.Nexus.WebUI.Models.JobTitle", "JobTitle")
                        .WithMany("HeadCountItems")
                        .HasForeignKey("JobTitleId")
                        .IsRequired()
                        .HasConstraintName("FK_HeadCountItem_HeadCountItem1");
                    ...
                    b.HasOne("Reflections.Nexus.WebUI.Models.Country", "WorkingModel")
                        .WithMany("HeadCountItems")
                        .HasForeignKey("WorkingModelId")
                        .IsRequired()
                        .HasConstraintName("FK_HeadCountItem_Nationality");

                    b.HasOne("Reflections.Nexus.WebUI.Models.WorkingModel", "WorkingModelNavigation")
                        .WithMany("HeadCountItems")
                        .HasForeignKey("WorkingModelId")
                        .IsRequired()
                    ...
                    b.Navigation("WorkingModelNavigation");
                });
